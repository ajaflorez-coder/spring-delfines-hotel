...
public class VendedorServiceImpl implements VendedorService{
	...
	@Override
	public List<Vendedor> listaVendedores() throws Exception {
		// TODO Auto-generated method stub
		return vendedorRepository.listavendedores();
	}

	//@Override
	//public List<Vendedor> listavensuel(double sueldo) throws Exception {
		// TODO Auto-generated method stub
		//return vendedorRepository.listavensuel(sueldo);
	//}
