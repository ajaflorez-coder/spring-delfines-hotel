...
public class HabitacionController {
	...
	@Autowired
	private TipoService clienteService;
	...
	@GetMapping("/edit/{id}")
	public String actualizarHabitacion(@PathVariable("id") int id, Model model) {
		try {
	...
	@GetMapping("/nuevo")
	public String RegistarHabitacion(Model model) {
	...
	@GetMapping("/del/{id}")
	public String eliminarHabitacion(@PathVariable("id") int id, Model model) {
		try {
